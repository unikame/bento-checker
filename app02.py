...
[data-testid="stSidebar"] .stMarkdown p { color: white !important; font-weight: 600; }

/* アップロードエリアの白飛びを修正 (ダークモード対応) */
...
/* アップロード済みファイルのリスト色を調整 */
[data-testid="stSidebar"] div[data-test-metric-container] { color: white !important; }
