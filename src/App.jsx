...
- 上段: 左に小さい区画（副菜A）、右に大きい区画（メイン）
- 下段: 左に大きい区画（ご飯）、右に小さい区画（副菜B）
...
【重要な指示】
- 座標は区画の内側の縁（仕切り線のすぐ内側）にぴったり合わせてください
- 容器の外側の背景（木目など）は含めないでください
- 隣の区画に食み出さないでください
- 食材ではなく、区画の壁の位置を基準にしてください
- 画像をじっくり観察して、仕切り線の正確な位置を特定してください

【座標の指定】
- x1, y1: 区画の左上の座標（画像全体に対する比率 0.0〜1.0）
- x2, y2: 区画の右下の座標
- 例: 画像の左半分なら x1=0.0, x2=0.5
